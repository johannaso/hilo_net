...
class Unet(pl.LightningModule):
    def __init__(self, hparams):
        ...
        self.up3 = up(256, 64)
        self.up4 = up(128, 64)
        self.out = nn.Conv2d(64, self.n_classes, kernel_size=1) ## To Do: Output Layer anpassen! --> Keine Klassen
    ...
    def __dataloader(self): #To Do: Dataloader auf Dataset anpassen
